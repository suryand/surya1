...
public class CatalogWomensActivity extends Activity {
	...
	//	mProductList = ShoppingCartHelper.getCatalog(getResources(), 3);
		mProductList = new Vector<Product>();
		ShoppingCartHelper.getCatalog(getResources(), mProductList, 3);
		...
		listViewCatalogSelected.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
				...
				productDetailsIntent.putExtra(ShoppingCartHelper.PRODUCT_DEPT, 3);
