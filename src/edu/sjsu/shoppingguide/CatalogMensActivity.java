...
public class CatalogMensActivity extends Activity {
	...
	//	mProductList = ShoppingCartHelper.getCatalog(getResources(), 2);
		mProductList = new Vector<Product>();
		ShoppingCartHelper.getCatalog(getResources(), mProductList, 2);
		...
		listViewCatalogSelected.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
				...
				productDetailsIntent.putExtra(ShoppingCartHelper.PRODUCT_DEPT, 2);
