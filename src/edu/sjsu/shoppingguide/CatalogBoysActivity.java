...
public class CatalogBoysActivity extends Activity {
	...
	//	mProductList = ShoppingCartHelper.getCatalog(getResources(), 4);
		mProductList = new Vector<Product>();
		ShoppingCartHelper.getCatalog(getResources(), mProductList, 4);
		...
		listViewCatalogSelected.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position,
				...
				productDetailsIntent.putExtra(ShoppingCartHelper.PRODUCT_DEPT, 4);
